...
export default function Header() {
    return (
        <header className="flex bg-white items-center justify-between px-6 py-2 sticky top-0 z-10 dark:border-b dark:border-[#333]">
