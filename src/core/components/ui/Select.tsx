...
export default function Select({ name, value, onChange, options, placeholder, className}: SelectProps) {
    ...
    return (
        <div className={`relative ${className}`} ref={dropdownRef}>
            ...
            <Button
                type="button"
                className="w-full bg-dark-bg/50 border border-white/10 rounded-[8px] p-2 text-sm text-left text-white outline-none focus:border-purple-400 focus:ring-1 focus:ring-purple-400/50 transition-all flex items-center justify-between shadow-sm hover:border-white/20 h-[42px]"
